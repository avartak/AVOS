...
#define X86_PAGING_PDE_SIZE           0x400000
...
#define X86_PAGING_PTE_SIZE           0x1000
...
#define X86_PAGING_PGDIR_IDX(x)       (((uintptr_t)(x) >> 22) & 0x3FF)
#define X86_PAGING_PGTAB_IDX(x)       (((uintptr_t)(x) >> 12) & 0x3FF)

#define X86_PAGING_ROUNDUPPAGE(x)     (((uintptr_t)(x)+X86_PAGING_PAGESIZE−1) & ~(X86_PAGING_PAGESIZE−1))
#define X86_PAGING_ROUNDDOWNPAGE(x)   ( (uintptr_t)(x)                        & ~(X86_PAGING_PAGESIZE−1))
