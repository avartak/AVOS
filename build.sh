...
i386-elf-ld -m elf_i386 -T link.ld  -o kernel.bin  start.o kernel.o physmem.o memory.o heap.o kinit.o gdt.o gdt_asm.o tss.o paging.o idt.o interrupts_asm.o interrupts.o pic.o welcome.o keyboard.o string.o
