...
gcc --target=i386-jos-elf -ffreestanding -nostdlib -fno-builtin -fno-stack-protector -nodefaultlibs -Wall -Wextra -Werror -std=c99 -I /Users/avartak/AVOS/AVOS -c kernel/src/chunk.c

i386-elf-ld -m elf_i386 -T link.ld  -o kernel.bin  start.o kinit.o kernel.o physmem.o memory.o chunk.o checks.o paging.o gdt.o gdt_asm.o tss.o idt.o interrupts_asm.o interrupts.o pic.o irqs.o welcome.o keyboard.o string.o
