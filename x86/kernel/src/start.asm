...
global Multiboot2_Header_tag6
Multiboot2_Header_tag6_start:
Multiboot2_Header_tag6:
    .type          dw    6
    .flags         dw    0
    .size          dd    Multiboot2_Header_tag6_end - Multiboot2_Header_tag6_start
Multiboot2_Header_tag6_end:
